...
if os.path.exists(os.path.join(path_models, "sampling_boostEDN.json")):
    # Load sampling from disk
    with open(os.path.join(path_models, "sampling_boostEDN.json"), "r") as json_reader:
    ...
    for i, fold in enumerate(subsets):
        ...
        sampling_dict["cv_" + str(i)] = {"x_train": x_train.tolist(),
                                         ...
                                         "x_val": x_val.tolist(),
                                         "y_val": y_val.tolist()}
    with open(os.path.join(path_models, "sampling_boostEDN.json"), "w") as file:
...
path_detect = os.path.join(path_models, "boostEDN_" + arch)
